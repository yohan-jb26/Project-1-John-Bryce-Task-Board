...
/*
let save = document.getElementById('save').addEventListener("click", function Add() {
})
    let reset = document.getElementById('reset').addEventListener("click", function Cancel() {
        document.getElementById("taskData").innerHTML = "";
        document.getElementById("taskDate").innerHTML = "2020-01-01";
        document.getElementById("taskTime").innerHTML = "00:00";
    })
